...
def stackHDRs(image_files, output_filename, chunk_size=2):
    # เช็คว่ามีกี่กลุ่ม โดยเอาจำนวนรูปทั้งหมดหาร 5 (ถ้าเหลือเศษจากการหาร (เศษไม่เท่ากับ 0) จะเพิ่ม 1 เข้าไปที่ num_chunks)
    ...
    final_image = FocusStack.focus_stack(merged_images)
